...
resource "aws_s3_bucket_server_side_encryption_configuration" "encryptTerraformState" {
...
# Module for Security Groups, this will create Security Groups for Each layer of the infrastructure
